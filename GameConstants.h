...
#define WINDOW_TITLE "Space Invader - The Game"
...
enum gameState { MENU, INSTRUCTIONS, PLAYING, END, QUIT, LOADMAP, SAVEMAP, REPEAT };
enum btnTypes { EXIT, INSTRUCT, LOAD, PLAY, SAVE, SETTINGS, REPLAY };
#endif